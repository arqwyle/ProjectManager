...
public class EmployeeServiceTests
{
    ...
    {
        var employees = new List<Employee> { new() { FirstName = "Test", LastName = "Test", Patronymic =  "Test", Mail = "Test" } };
    ...
    {
        var id = Guid.NewGuid();
        var employee = new Employee{ FirstName = "Test", LastName = "Test", Patronymic =  "Test", Mail = "Test" };
